...
st.markdown('<div class="muted">Use the left sidebar to navigate between pages.</div>', unsafe_allow_html=True)
st.markdown("---")
...
try:
    ...
    st.error("sample_creditcard.csv missing. Add it to repo root or upload it in the Resources page.")
# END FIXED
